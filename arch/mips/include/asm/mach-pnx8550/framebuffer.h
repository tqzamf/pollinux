...
// fakeHD filter layer dimensions
#define PNX8550FB_FILTERLAYER_WIDTH 4
#define PNX8550FB_FILTERLAYER_HEIGHT 1080
#define PNX8550FB_FILTERLAYER_STRIDE \
		(PNX8550FB_FILTERLAYER_WIDTH * PNX8550FB_PIXEL) /* must be multiple of 8 */
#define PNX8550FB_FILTERLAYER_SIZE \
		(PNX8550FB_FILTERLAYER_STRIDE * PNX8550FB_FILTERLAYER_HEIGHT)
#define PNX8550FB_FILTERLAYER_ALLOC 12288 /* page alignment */
