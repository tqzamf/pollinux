...
// GPIO def
#define _PNX8550_GPIO_BASE	PNX8550_MMIO_BASE_ADDR

#define PNX8550_GPIO_DIRQ0	 (_PNX8550_GPIO_BASE + 0x104500)
#define PNX8550_GPIO_DIRQ(x)	 (0x104500 + ((x)*4))
#define PNX8550_GPIO_MC1         (_PNX8550_GPIO_BASE + 0x104004)
