...
Currently available applets include:
	...
	bash, blkid, blockdev, brctl, bunzip2, bzcat, cat, catv, chgrp,
	chmod, chown, chroot, cksum, clear, cmp, cp, cryptpw, cttyhack, cut,
	date, dd, delgroup, deluser, depmod, devmem, df, diff, dirname,
	dmesg, dnsdomainname, dos2unix, dpkg, du, echo, egrep, eject, env,
	expr, false, fgrep, find, findfs, flock, free, fstrim, fsync, fuser,
	getopt, grep, groups, gunzip, gzip, halt, hd, head, hexdump,
	hostname, hwclock, id, ifconfig, insmod, ionice, iostat, ip, ipaddr,
	iplink, iproute, iprule, iptunnel, kill, killall, killall5, less,
	ln, losetup, ls, lsmod, lsof, lspci, lsusb, md5sum, mdev, microcom,
	mkdir, mkfifo, mknod, mkpasswd, mkswap, mktemp, modinfo, modprobe,
	more, mount, mountpoint, mv, nameif, nanddump, nandwrite,
	nbd-client, nc, netstat, nice, nohup, nslookup, ntpd, passwd, patch,
	pidof, ping, ping6, pmap, poweroff, printenv, printf, ps, pstree,
	pwd, readlink, realpath, reboot, renice, reset, resize, rfkill, rm,
	rmdir, rmmod, route, rx, sed, seq, setconsole, setlogcons, setsid,
	sh, sha1sum, sleep, sort, split, stat, strings, stty, su, sum,
	swapoff, swapon, switch_root, sync, tail, tar, tee, test, tftp,
	time, timeout, top, touch, tr, true, tty, tunctl, udhcpc, udhcpc6,
	umount, uname, uniq, unix2dos, unzip, uptime, usleep, uudecode,
	uuencode, vi, wc, wget, which, whoami, xargs, yes, zcat, zcip
...
tar -[xtzjmvO] [-X FILE] [-T FILE] [-f TARFILE] [-C DIR] [FILE]...
...
udhcpc6 [-fbnqvoR] [-i IFACE] [-r IP] [-s PROG] [-p PIDFILE]
	[-x OPT:VAL]... [-O OPT]... [-P N]
